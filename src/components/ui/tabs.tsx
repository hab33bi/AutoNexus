...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-white/10 p-1 backdrop-blur-md",
      className
    )}
    {...props}
  />
